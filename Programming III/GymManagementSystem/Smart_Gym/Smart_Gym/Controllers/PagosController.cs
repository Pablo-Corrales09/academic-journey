...
namespace Smart_Gym.Controllers
{
    public class PagosController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Pago.Include(p => p.Membresia);
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaPago,Monto,CodigoTransaccion,MembresiaId")] Pago pago)
        {
            try
            {
                _context.Add(pago);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FechaPago,Monto,CodigoTransaccion,MembresiaId")] Pago pago)
        {
            if (id != pago.Id)
            {
                return NotFound();
