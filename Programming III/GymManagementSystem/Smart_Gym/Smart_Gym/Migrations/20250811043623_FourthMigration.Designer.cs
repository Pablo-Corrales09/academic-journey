...
namespace Smart_Gym.Migrations
{
    ...
    [Migration("20250811043623_FourthMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smart_Gym.Models.Factura", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smart_Gym.Models.Membresia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smart_Gym.Models.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smart_Gym.Models.Factura", b =>
                {
                    b.HasOne("Smart_Gym.Models.Membresia", "Membresia")
                        .WithOne("Factura")
                        .HasForeignKey("Smart_Gym.Models.Factura", "MembresiaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Smart_Gym.Models.Membresia", b =>
                {
                    b.HasOne("Smart_Gym.Models.Usuario", "Cliente")
                        .WithMany("Membresias")
